...
export const templates = {
    ...
    "index.html": `
        <section class="hero">
            ...
            <figure class="hero-imagem">
                <img src="assets/banner.jpg" alt="banner do site referente a tecnologia e a sociedade">
            </figure>
        </section>
        ...
        <section class="sobre">
            ...
            <figure>
                <img src="assets/projetos-banner.jpg" alt="banner do site referente a inclusão social">
            </figure>
        </section>
        ...
        <section class="projetos">
            ...
            <div class="cards">
                <article class="card">
                    <img src="assets/projeto-1.jpg" alt="Crianças participando de atividade educacional">
                    <div>
                ...
                <article class="card">
                    <img src="assets/projeto-4.jpg" alt="Voluntários organizando alimentos para doação">
                    <div>
    ...
    "projetos.html": `
        <section class="hero">
            ...
            <figure class="hero-imagem">
                <img src="assets/projetos-banner.jpg" alt="Voluntários reunidos durante uma ação comunitária">
            </figure>
        </section>
        ...
        <article class="projeto-detalhado">
            <figure>
                <img src="assets/projeto-1.jpg" alt="Crianças participando de uma atividade educacional">
            </figure>
        ...
        <article class="projeto-detalhado">
            <figure>
                <img src="assets/projeto-3.jpg" alt="Pessoa participando de uma oficina de informática">
            </figure>
            <div class="explicacao-projetos">
                <span class="badge badge-ativo">Projeto ativo</span>
    ...
    "cadastro.html": `
        <section class="hero">
            ...
            <figure class="hero-imagem">
                <img src="assets/projeto-2.jpg" alt="Grupo de voluntários trabalhando em uma ação social">
            </figure>
        </section>
